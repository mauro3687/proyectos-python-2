...
def toma():
    ...
    botonVolver=PhotoImage(file='volver.png')
    volver=Button(raiz1,image=botonVolver)
...
def toma2():
    ...
    etiN=Label(mi_frame,text="tipo de pizza").grid(row=0,column=100,pady=10,padx=2)
